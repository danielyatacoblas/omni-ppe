...
MODELOS = [
    ("weights/sh17_yolo9e.pt", "EPP, 17 clases — el que usa la app",
     "videos/video_1.mp4", 0.25),
    ("weights/sh17_yolo8m.pt", "EPP, variante más rápida",
     "videos/video_1.mp4", 0.25),
    ("weights/css_voxdroid.pt", "Puesto / no puesto (comparador)",
     "videos/video_1.mp4", 0.25),
    ("weights/hafizqaim.pt", "Puesto / no puesto (comparador)",
     "videos/video_1.mp4", 0.25),
]

# Lo que publica quien entrenó cada modelo, para lo que el .pt no trae.
FUENTES = {
    "sh17_yolo9e.pt": ("SH17 · CC BY-NC-SA 4.0",
     "https://github.com/ahmadmughees/SH17dataset"),
    "sh17_yolo8m.pt": ("SH17 · CC BY-NC-SA 4.0",
     "https://github.com/ahmadmughees/SH17dataset"),
    "css_voxdroid.pt": ("Construction Site Safety · VoxDroid",
     None),
    "hafizqaim.pt": ("Workspace Safety Detection · hafizqaim",
     None),
}
